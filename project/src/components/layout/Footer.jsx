    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">{STORE_INFO.name}</h3>
            <p className="text-gray-300">{STORE_INFO.address}</p>
            <p className="text-gray-300">{STORE_INFO.phone}</p>
            <p className="text-gray-300">{STORE_INFO.email}</p>
          </div>
          <div>
